...
exports.stealth_memo_data = exports.signed_transaction = exports.transaction = exports.settle_credit_operation = exports.comment_credit_request_operation = exports.credit_request_cancel_operation = exports.credit_approve_operation = exports.credit_request_operation = exports.credit_request_operation_ = exports.asset_claim_fees = exports.asset_settle_cancel = exports.transfer_from_blind = exports.blind_transfer = exports.blind_input = exports.transfer_to_blind = exports.blind_output = exports.stealth_confirmation = exports.override_transfer = exports.balance_claim = exports.assert = exports.block_id_predicate = exports.asset_symbol_eq_lit_predicate = exports.account_name_eq_lit_predicate = exports.custom = exports.worker_create = undefined;
...
var credit_request_operation_ = exports.credit_request_operation_ = new Serializer("credit_request_operation_", {
    fee: asset,
...
var credit_request_operation = exports.credit_request_operation = new Serializer("credit_request_operation", {
    fee: asset,
    borrower: protocol_id_type("account"),
    loan_asset: asset,
    loan_period: uint32,
...
var credit_approve_operation = exports.credit_approve_operation = new Serializer("credit_approve_operation", {
    fee: asset,
...
var credit_request_cancel_operation = exports.credit_request_cancel_operation = new Serializer("credit_request_cancel_operation", {
    fee: asset,
    borrower: protocol_id_type("account"),
    borrow_memo: string,
    credit_request_uuid: string
...
var comment_credit_request_operation = exports.comment_credit_request_operation = new Serializer("comment_credit_request_operation", {
    fee: asset,
    creditor: protocol_id_type("account"),
    credit_memo: string,
    credit_request_uuid: string
...
var settle_credit_operation = exports.settle_credit_operation = new Serializer("settle_credit_operation", {
    fee: asset,
    borrower: protocol_id_type("account"),
    credit_request_uuid: string
});
